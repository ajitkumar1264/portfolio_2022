...
const modechange=()=>{
  ...
  setyellshadow({
    "boxShadow":"0 20px 25px -5px rgb(252 163 17 / 0.1),0 8px 10px -6px rgb(252 163 17 / 0.1)"
  })
      ...
      <div className="flex justify-between items-center w-auto h-full px-2 2xl:px-16">
       <h1 className=" text-4xl ml-5  font-semibold">Annex<span className="text-[#5651e5] text-4xl">4u</span></h1>
        ...
        <div>
          ...
          <div onClick={handlenav} className= "md:hidden mr-5 rounded-full  shadow-gray-400 p-3 cursor-pointer">
            <AiOutlineMenu/>
          </div>
        </div>
      </div>
        ...
        <div className={nav ? " md:hidden fixed top-0 left-0 w-[75%] sm:w-[60%] md:w-[45%] h-screen bg-[#ecf0f3] p-10 easein duration-500":"fixed top-0 left-[-100%] p-10 ease-in duration-500"} >
          <div>
            <div className="flex w-full items-center justify-between">
              ...
              <div onClick={handlenav} className="rounded-full shadow-lg text-black shadow-gray-400 p-3 cursor-pointer   ">
                <AiOutlineClose />
              </div>
            </div>
