  ...
  return (
    ...
    <div className="w-screen h-[30vh] lg:h-[40vh] relative ">
      <div className=" absolute top-0 left-0 w-full h-[30vh] lg:h-[40vh]  z-1 overflow-hidden  ">
        ...
        <div className="absolute md:top-[60%] top-[50%] md:left-40 left-10  max-w-[1240px] w-full text-black">
          <h2>Annex Qrcode Simulator</h2>
          <h3 className="py-4">React js /Tailwind / npm</h3>
        </div>
      </div>
    </div>
    ...
    <div className="max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 pt-8 md:px-0 px-5">
      <div className="col-span-4 ">
        ...
        <h2>overview</h2>
        <p className="py-4">
       scan any qr-code and generate any qr-code within few seconds.
        </p>
      <Link href="https://annex4u.netlify.app/">  <button className={ajx.darkmode ? "px-8 py-2 mt-4 mr-8 shadow-none":"px-8 py-2 mt-4 mr-8"}>demo</button></Link>
       <Link href="https://github.com/ajitkumar1264/Annex-qr-code-simulator" > <button  className={ajx.darkmode ? "px-8 py-2 mt-4 mr-8 shadow-none":"px-8 py-2 mt-4 mr-8"}>code</button></Link>
      </div>
      ...
      <div className={ajx.darkmode ? "col-span-4 md:col-span-1 shadow-sm shadow-amber-400 rounded-xl p-4":"col-span-4 md:col-span-1 shadow-xl shadow-gray-400 rounded-xl p-4"}>
        <div className="p-2">
          ...
          <div className="grid grid-cols-2 md:grid-cols-1">
            ...
            <p className={ajx.darkmode ? "text-white py-2 items-center flex gap-3":"text-gray-600 py-2 items-center flex gap-3"}>
              {" "}
              <RiRadioButtonFill className="pr-1" /> npm package
            </p>
          </div>
        </div>
      </div>
