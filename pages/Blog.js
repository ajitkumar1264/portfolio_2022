  ...
  return (
    ...
    <div className="max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 pt-8 md:px-0 px-5">
      <div className="col-span-4 ">
        ...
        <h2>overview</h2>
        <p className="py-4">
        Sign with Google, Add Post and Give like,Show Profile, Contact
me, Delete Post ,Search Post, Add Tags,Email Verification

        </p>
     <Link href="https://react-chatapp-f669f.firebaseapp.com/">   <button className={ajx.darkmode ? "px-8 py-2 mt-4 mr-8 shadow-none":"px-8 py-2 mt-4 mr-8"}>demo</button></Link>
     <Link href="https://github.com/ajitkumar1264/Annex-blog">   <button  className={ajx.darkmode ? "px-8 py-2 mt-4 mr-8 shadow-none":"px-8 py-2 mt-4 mr-8"}>code</button></Link>
      </div>
